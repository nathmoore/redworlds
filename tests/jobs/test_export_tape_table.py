...
from redworlds.jobs.export_tape_table import SCHEMA_PATH, build_tape_table, write_tape_table
...
def test_build_table_solves_ready_y_side_tapes_and_keeps_held_record(test_mrio: pymrio.IOSystem) -> None:
    ...
    table = build_tape_table(
        test_mrio,
        {"reduce": reduce, "swap": swap, "held": held},
        baskets,
        baseline="test",
