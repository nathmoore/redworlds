...
@pytest.mark.skip(reason="scale_final_demand not yet implemented — see docs/backlog.md")
...
@pytest.mark.skip(reason="get_sector_emissions not yet implemented — see docs/backlog.md")
